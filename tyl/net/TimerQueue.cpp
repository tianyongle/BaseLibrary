...
int createTimerfd()
{
	...
	if (timerfd < 0)
	{
		LFATAL << "Failed in timerfd_create";
	}
	return timerfd;
}
...
void readTimerfd(int timerfd, Timestamp now)
{
	...
	LTRACE << "TimerQueue::handleRead() " << howmany << " at " << now.toString();
	if (n != sizeof howmany)
	{
		LERROR << "TimerQueue::handleRead() reads " << n << " bytes instead of 8";
	}
}
...
using namespace tyl::net::detail;
